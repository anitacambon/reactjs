    ...
    return (
        <div className='Body'>
            ...
            <div className='actividad'>
                <img src={imgActEscuelita} className="img-act" alt="imagen jiu jitsu"></img>
                <h4>¿De qué consta la escuelita?</h4>
                <p className='text'>Iniciación deportiva orientada a las artes marciales</p>
                <p className='text'>Boxeo infantil sin contacto</p>
                <p className='text'>Brazilian Jiu Jitsu infantil</p>
                <p className='text'>Taekwondo ITF</p>
            </div>
            <hr></hr>
            <div className='actividad'>
                <img src={imgEscPrep} className="img-act" alt="imagen jiu jitsu"></img>
                <h4>Iniciación Deportiva orientada a las Artes Marciales</h4>
                <h5>Para niños y niñas de 5 a 8 años</h5>
                ...
                <p className='text'>El objetivo de la clase no está en la enseñanza de las técnicas propias del arte marcial en el que se especializa el profesor, sino en el desarrollo de las habilidades motoras necesarias para que en un futuro las específicas sean más fáciles de incorporar.
                    ...
                    Se hace foco específicamente en que los niños incorporen hábitos de orden, atención, respeto hacia el prójimo y el compañerismo.</p>
            </div>
            <hr></hr>
            <div className='actividad'>
                <img src={imgEscBOX} className="img-act" alt="imagen jiu jitsu"></img>
                <h4>Boxeo Infantil sin Contacto</h4>
                <h5>Para niños y niñas de 8 a 12 años</h5>
            ...
            <hr></hr>
            <div className='actividad'>
                <img src={imgEscBJJ} className="img-act" alt="imagen jiu jitsu"></img>
                <h4>Brazilian Jiu Jitsu infantil</h4>
                <h5>Para niños y niñas de 8 a 12 años</h5>
            ...
            <hr></hr>
            <div className='actividad'>
                <img src={imgEscTKD} className="img-act" alt="imagen jiu jitsu"></img>
                <h4>Taekwondo ITF</h4>
                <h5>Para niños y niñas de 8 a 12 años</h5>
                ...
                <h5>Profesores a cargo: </h5>
                <p className='prof'>Felix Perez Sanches <Link className="insta" to='https://www.instagram.com/fpsanchezz/' target="blank">@fpsanchezz</Link></p>
            </div>
            <hr></hr>
            <div className='actividadFin'>
                <h4>¿Qué necesito para la práctica?</h4>
